...
import {
    ...
    GENERATED_TITLE,
    generateScalaFile,
    INVALID_CHAR_IN_TITLE_ERROR, RESERVED_FILENAME_ERROR, generateTitle
} from "../ScalaGenerator";
...
test('ScalaGenerator.generateTitle() returns a valid \'.scl\' file title.', () => {

    // Act
    let test = generateTitle();
...
// TODO: uncomment once scale settings are done
